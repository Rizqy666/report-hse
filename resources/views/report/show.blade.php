                    ...
                    <div class="card-body">
                        <div class="card-body">
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                ...
                                {{-- <button class="btn btn-danger btn-block mb-3" id="exportButton"
                                    onclick="window.location.href='{{ route('hse_report.export', $report->id) }}'">Export to
                                    PDF</button> --}}
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <input type="checkbox" class="form-check-input ms-auto" id="posture"
                                                        ...
                                                        {{ isset($report->ergonomic['posture']) ? 'checked' : '' }}
                                                        disabled>
                                                </div>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <input type="checkbox" class="form-check-input ms-auto"
                                                        ...
                                                        {{ isset($report->ergonomic['inhaling']) ? 'checked' : '' }}
                                                        disabled>
                                                </div>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <input type="checkbox" class="form-check-input ms-auto"
                                                        ...
                                                        {{ isset($report->ergonomic['vibration']) ? 'checked' : '' }}
                                                        disabled>
                                                </div>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <input type="checkbox" class="form-check-input ms-auto"
                                                        ...
                                                        {{ isset($report->ergonomic['absorbing']) ? 'checked' : '' }}
                                                        disabled>
                                                </div>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <input type="checkbox" class="form-check-input ms-auto"
                                                        ...
                                                        {{ isset($report->environment['noise']) ? 'checked' : '' }}
                                                        disabled>
                                                </div>
                                            ...
                                            <td class="align-middle">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <input type="checkbox" class="form-check-input ms-auto"
                                                        ...
                                                        {{ isset($report->tools['right_tool']) ? 'checked' : '' }}
                                                        disabled>
                                                </div>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <input type="checkbox" class="form-check-input ms-auto"
                                                        ...
                                                        {{ isset($report->environment['others3']) ? 'checked' : '' }}
                                                        disabled>
                                                </div>
