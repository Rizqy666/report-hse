                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4 mb-3">
                            <?php if($report->feedback): ?>
                                ...
                                <div class="d-flex flex-column align-items-start mb-3">
                                    <span class="badge <?php echo e($report->feedback === 'approve' ? 'bg-success' : 'bg-danger'); ?>">
                                        <?php echo e(ucfirst($report->feedback)); ?>

                                    </span>
                                    <span class="mt-2">Ket : <?php echo e(ucfirst($report->reason)); ?></span>
                                </div>
                            <?php else: ?>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                                ...
                                                onclick="setAction('approve', <?php echo e($report->id); ?>)">
                                                Setujui
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                                data-bs-target="#feedbackModal"
                                                onclick="setAction('reject', <?php echo e($report->id); ?>)">
                                                Tolak
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 33%">Reported By :
                                            <strong><?php echo e($report->reported_by); ?></strong>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                ...
                                                <input type="checkbox" class="form-check-input ms-auto" id="posture"
                                                    ...
                                                    <?php echo e(isset($report->ergonomic['posture']) ? 'checked' : ''); ?> disabled>
                                            </div>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                ...
                                                <input type="checkbox" class="form-check-input ms-auto" id="trunk"
                                                    name="ppe[trunk]" <?php echo e(isset($report->ppe['trunk']) ? 'checked' : ''); ?>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                ...
                                                <input type="checkbox" class="form-check-input ms-auto" id="inhaling"
                                                    ...
                                                    <?php echo e(isset($report->ergonomic['inhaling']) ? 'checked' : ''); ?> disabled>
                                            </div>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                ...
                                                <input type="checkbox" class="form-check-input ms-auto" id="vibration"
                                                    ...
                                                    <?php echo e(isset($report->ergonomic['vibration']) ? 'checked' : ''); ?> disabled>
                                            </div>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                ...
                                                <input type="checkbox" class="form-check-input ms-auto" id="body"
                                                    name="ppe[body]" <?php echo e(isset($report->ppe['body']) ? 'checked' : ''); ?>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                ...
                                                <input type="checkbox" class="form-check-input ms-auto" id="absorbing"
                                                    ...
                                                    <?php echo e(isset($report->ergonomic['absorbing']) ? 'checked' : ''); ?> disabled>
                                            </div>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                ...
                                                <input type="checkbox" class="form-check-input ms-auto" id="noise"
                                                    ...
                                                    <?php echo e(isset($report->environment['noise']) ? 'checked' : ''); ?> disabled>
                                            </div>
                                        ...
                                        <td class="align-middle">
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <input type="checkbox" class="form-check-input ms-auto" id="rightTool"
                                                    ...
                                                    <?php echo e(isset($report->tools['right_tool']) ? 'checked' : ''); ?> disabled>
                                            </div>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                ...
                                                <input type="checkbox" class="form-check-input ms-auto" id="others3"
                                                    ...
                                                    <?php echo e(isset($report->environment['others3']) ? 'checked' : ''); ?> disabled>
                                            </div>
